...
//        btnInHoaDon.setToolTipText("In Hóa Đơn");
    ...
    private void initComponents() {
        ...
        popMenuXoa = new javax.swing.JMenuItem();
        ...
        txtNgayKhachMuon = new javax.swing.JTextField();
        ...
        popMenuXoa.setText("Xóa");
        popMenuXoa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                popMenuXoaActionPerformed(evt);
            }
        });
        popMenuGH.add(popMenuXoa);
        ...
        txtSanPham.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtSanPhamKeyTyped(evt);
            }
        });
        ...
        panelBorder8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBorder8Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelBorder8Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(txtTenKH1, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(4, 4, 4)
            ...
            .addGroup(panelBorder8Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lbngayHienTai, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
                        ...
                        .addGroup(panelBorder11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(panelBorder11Layout.createSequentialGroup()
                                ...
                                .addGroup(panelBorder11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtNgayKhachMuon, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
        ...
        jLabel26.setText("Tiền Phát Sinh");
        ...
        btnGiaoHang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/Ship.png"))); // NOI18N
        ...
        panelBorder13Layout.setHorizontalGroup(
            ...
            .addGroup(panelBorder13Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnGiaoHang, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
        ...
        panelBorder13Layout.setVerticalGroup(
            ...
            .addGroup(panelBorder13Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnGiaoHang, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(panelBorder13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelBorder13Layout.createSequentialGroup()
    ...
    private BHHoaDonDM getInputTT() {
        ...
        a.setTongTien(BigDecimal.valueOf(Double.parseDouble(lbTongTien.getText())));
...
//        loadTBDSHD();
    ...
    private void popMenuXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_popMenuXoaActionPerformed
        // TODO add your handling code here:
        int row = tblGioHang.getSelectedRow();
        if (row != -1) {
            int luaChon = JOptionPane.showConfirmDialog(this, "Bạn Có Muốn Xóa Sản Phẩm Này Không???", "Xác Nhận", JOptionPane.YES_NO_OPTION);
            if (luaChon == JOptionPane.YES_OPTION) {
                int chonCot = tblHoaDon.getSelectedRow();
                String layMa = (String) tblHoaDon.getValueAt(chonCot, 0);
                int dongChonIDGH = tblGioHang.getSelectedRow();
//            String getIDGH = (String) tblGioHang.getValueAt(dongChonIDGH, 0);
                BHGioHangVM gioHang = ghsv.getOne(layMa).get(dongChonIDGH);
                ghsv.delete(gioHang.getIDHDCT());
                loadGioHang();
    ...
    }//GEN-LAST:event_popMenuXoaActionPerformed
...
//            laySLM = (int) tblGioHang.getValueAt(tblGioHang.getSelectedRow(), 7);
    ...
    private BHHoaDonDM getInputGiaoHang() {
        BHHoaDonDM a = new BHHoaDonDM();
        a.setTongTien(BigDecimal.valueOf(Double.parseDouble(lbTongTien1.getText())));
        a.setTienShip(BigDecimal.valueOf(Double.parseDouble(txtTienShip.getText())));
        a.setThanhTien(BigDecimal.valueOf(Double.parseDouble(lbThanhTien1.getText())));
        a.setSoTienGiam(BigDecimal.valueOf(Double.parseDouble(txtSoTienGiam1.getText())));
        a.setNgayGiao(lbngayHienTai1.getText());
        return a;
    }
    private void btnGiaoHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGiaoHangActionPerformed
        ...
        } else if (txtSoTienGiam1.getText().trim().isEmpty() || lbThanhTien1.getText().trim().isEmpty() || txtTienShip.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Mời Nhập Số Tiền Giao Hàng!!!");
        } else if (Double.parseDouble(txtSoTienGiam1.getText()) < 0 || Double.parseDouble(txtTienShip.getText()) < 0) {
            JOptionPane.showMessageDialog(this, "Mời Nhập Thông Tin Thanh Toán Lớn Hơn 0!!!");
        } else {
            String layGiaTri = (String) tblHoaDon.getValueAt(chonCot, 0);
            hdsv.updateGiaoHang(getInputGiaoHang(), layGiaTri);
    ...
    private BHHoaDonDM getInputGiaoHangThanhCong() {
        BHHoaDonDM hoaDon1 = new BHHoaDonDM();
        hoaDon1.setNgayGiaoThanhCong(lbngayHienTai1.getText());
        return hoaDon1;
    }
    private void btnDaGiaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDaGiaoActionPerformed
        // TODO add your handling code here:
        int chonCot = tblHoaDon.getSelectedRow();
        int luaChon = JOptionPane.showConfirmDialog(this, "Hóa Đơn Đã Giao Thành Công???", "Xác Nhận", JOptionPane.YES_NO_OPTION);
        if (chonCot < 0) {
            JOptionPane.showMessageDialog(this, "Mời Chọn Hóa Đơn Đã Giao Thành Công");
        } else if (luaChon == JOptionPane.YES_OPTION) {
            String layGiaTri = (String) tblHoaDon.getValueAt(chonCot, 0);
            hdsv.updateGiaoHangThanhCong(getInputGiaoHangThanhCong(), layGiaTri);
            JOptionPane.showMessageDialog(this, "Đơn Hàng Đã Giao Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Đơn Hàng Chưa Được Giao Thành Công");
        }
    ...
    private void txtTienShipKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTienShipKeyTyped
        ...
        } else if (Double.parseDouble(txtTienShip.getText()) >= Double.parseDouble(lbTongTien1.getText())) {
            JOptionPane.showMessageDialog(this, "Số Tiền Ship Không Lớn Hơn Tổng Tiền");
        } else {
            double thanhTien = 0;
            BigDecimal bgThanhTien = new BigDecimal(Double.toString(thanhTien));
            double tienShip = 0;
            BigDecimal bgTienShip = new BigDecimal(Double.toString(tienShip));
//            BigDecimal tienShip = new BigDecimal(Double.parseDouble(txtTienShip.getText()));

            bgThanhTien = BigDecimal.valueOf(Double.parseDouble(lbTongTien1.getText()))
                    .subtract(BigDecimal.valueOf(Double.parseDouble(txtSoTienGiam1.getText())));

            bgTienShip = bgThanhTien.add(BigDecimal.valueOf(Double.parseDouble(txtTienShip.getText())));
            lbThanhTien1.setText(String.valueOf(bgTienShip));
        }
    }//GEN-LAST:event_txtTienShipKeyTyped

    private void txtSanPhamKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSanPhamKeyTyped
        // TODO add your handling code here:
        List<BHSanPhamVM> listSP = spsv.findCTSPByCam(txtSanPham.getText());
        DefaultTableModel model = new DefaultTableModel();
        model.setRowCount(0);
        model.setColumnIdentifiers(new String[]{"Mã sản phâm", "Tên sản phẩm", "Tên loại", "Chất liệu", "Màu sắc", "Size", "Xuất xứ", "Giá bán", "Số lượng tồn"});
        for (BHSanPhamVM x : listSP) {
        ...
        tblDSSP.setModel(model);
    }//GEN-LAST:event_txtSanPhamKeyTyped
    ...
    private void tblGioHangMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblGioHangMouseReleased
        ...
        if (evt.getButton() == MouseEvent.BUTTON3) {
            if (evt.isPopupTrigger() && tblGioHang.getSelectedRowCount() != 0) {
                popMenuGH.show(evt.getComponent(), evt.getX(), evt.getY());
            }
        }
    ...
    private javax.swing.JMenuItem popMenuXoa;
    ...
    private javax.swing.JTextField txtNgayKhachMuon;
