 ...
 * @author longd
 */
public class ThongTinSanPhamVM {
    ...
    public ThongTinSanPhamVM() {
    }

    public ThongTinSanPhamVM(String maSP, String tenSP, Integer soLuong, BigDecimal donGia, BigDecimal soTienGiamGia, BigDecimal thanhTien, Integer trangThai, String lyDoHuy) {
        this.maSP = maSP;
        this.tenSP = tenSP;
