...
Create table HoaDon(
 ...
 NgayGiaoThanhCong DATE DEFAULT NULL,
 TrangThai INT DEFAULT 0
)
--ChatLieu
...
LyDoHuy NVARCHAR(100) DEFAULT NULL,
TrangThai INT DEFAULT 0
)
GO
--GioHangChiTiet
...
--GiaoCa
Create TABLE GiaoCa(
	IDGC UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
	MaGC VARCHAR(20) UNIQUE,
	ThoiGianNhanCa DATETIME,
	ThoiGianGiaoCa DATETIME,
	IdNvTrongCa UNIQUEIDENTIFIER DEFAULT NULL,
	IdNvCaTiepTheo UNIQUEIDENTIFIER DEFAULT NULL,
	...
	GhiChuPhatSinh NVARCHAR(max) NULL,
	TongTienMatCaTruoc MONEY DEFAULT NULL,
	ThoiGianReset DATETIME,
	IdChuCuaHangReset UNIQUEIDENTIFIER DEFAULT NULL,
	TongTienMatRut MONEY DEFAULT NULL,
	TrangThai INT DEFAULT 0
)
...
--GiaoCa - Nhan Vien
ALTER TABLE [dbo].[GiaoCa]  WITH CHECK ADD  CONSTRAINT [FK_GiaoCa_NhanVien] FOREIGN KEY([IdNvTrongCa])
REFERENCES [dbo].[NhanVien] ([IDNV])
GO

ALTER TABLE [dbo].[GiaoCa]  WITH CHECK ADD  CONSTRAINT [FK_GiaoCa_NhanVien1] FOREIGN KEY([IdNvCaTiepTheo])
REFERENCES [dbo].[NhanVien] ([IDNV])
GO

ALTER TABLE [dbo].[GiaoCa]  WITH CHECK ADD  CONSTRAINT [FK_GiaoCa_NhanVien2] FOREIGN KEY([IdChuCuaHangReset])
REFERENCES [dbo].[NhanVien] ([IDNV])
GO