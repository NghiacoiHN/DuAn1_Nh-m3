...
SELECT ChiTietSanPham.MaCTSP, SanPham.TenSp, LoaiSP.TenLSP, ChatLieu.TenCL, MauSac.TenMS, Size.TenSize, ChiTietSanPham.GiaBan, ChiTietSanPham.SoLuongTon
FROM     ChiTietSanPham INNER JOIN
 ...
 ---WHERE TrangThai = 1 AND TrangThai = 2
--Hóa đơn chi tiết
...
('C97A89EA-F724-4EA6-97B6-15E2E48E0EFD','6E7E2035-DD3D-44EB-BB13-A4D9D24A8802',4,400000,1),
('C97A89EA-F724-4EA6-97B6-15E2E48E0EFD','AF4AC3F1-F9EA-48B9-973D-74563E2477C1',4,400000,1)
