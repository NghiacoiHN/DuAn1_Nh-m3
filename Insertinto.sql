...
INSERT INTO LoaiSPCT
                  (IDLSP, IDCTSP)
VALUES ('3CFED128-B6D0-44B3-8E57-6FE7F6FA9DF3','6E7E2035-DD3D-44EB-BB13-A4D9D24A8802'),
('72F431F9-975A-4719-B709-08509E7D9E62','AF4AC3F1-F9EA-48B9-973D-74563E2477C1')
Select*from LoaiSPCT
--Chi tiết sản phẩm
INSERT INTO ChiTietSanPham
                  (MaCTSP, IDCL, IDMS, IDSize, IDSP, MoTa, SoLuongTon, GiaNhap, GiaBan, TrangThai)
VALUES 
('CTSP01','5A3913D2-637F-421B-AB17-8A334E97BB45','2E5061BD-59AA-49A4-B42C-F507DFCC6B12','5BD7DF12-F018-427B-8FFD-D3BD688D151A',
...
('CTSP03','C010CEA1-D254-45E1-AD0C-3D65D202AA99','2E5061BD-59AA-49A4-B42C-F507DFCC6B12','5BD7DF12-F018-427B-8FFD-D3BD688D151A',
'8C7F2A96-CF65-4FDF-A5C0-897A68DE11C1',N'Đẹp',45,10000,200000,1)
...
FROM     ChiTietSanPham INNER JOIN
                  SanPham ON ChiTietSanPham.IDSP = SanPham.IDSP JOIN
                  ChatLieu ON ChiTietSanPham.IDCL = ChatLieu.IDCL JOIN
                  MauSac ON ChiTietSanPham.IDMS = MauSac.IDMS JOIN
                  Size ON ChiTietSanPham.IDSize = Size.IDSize JOIN 
				  LoaiSPCT ON ChiTietSanPham.IDCTSP = LoaiSPCT.IDCTSP JOIN
				  LoaiSP ON LoaiSP.IDLSP = LoaiSPCT.IDLSP
